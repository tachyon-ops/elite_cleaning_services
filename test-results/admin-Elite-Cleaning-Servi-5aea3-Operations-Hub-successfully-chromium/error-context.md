...
- Name: admin.spec.ts >> Elite Cleaning Services - Admin Dashboard Operations >> should load the Admin Operations Hub successfully
- Location: src/__tests__/e2e/admin.spec.ts:57:7
...
Locator: locator('h1:has-text(\'System Overview\')')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1:has-text(\'System Overview\')')
